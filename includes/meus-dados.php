<?php
if(file_exists("../set/Du-Art_fufewfeions.php")){ //excluir esse código
...
if(isset($_POST['email'],$_POST['senha'],$_POST['csenha'])){
	...
	if($status){
		mensagem_de_sucesso('Dados Alterados com Sucesso!');
	}else{
		mensagem_de_erro();
	}
}
...
$BODY['content'] = renderView('page-meus-dados',$dados);
